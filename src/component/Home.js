    ...
    <div className="home">
      ...
      <header className="header" id="Home">
        <div className="header-content">
          <h1>Streamline Every Shift with Employee Scheduling Software</h1>
          <p>Shift management has never been easier with Hubstaff’s scheduling, time tracking, budgeting, and PTO tools. Available on your desktop and mobile devices.</p><br/>
      ...
      <footer className="footer" id="contact">
        <div className="footer-content">
          ...
          <div className="footer-column">
            <h3>Contact</h3>
            <ul>
            <li>Email: <a href="https://mail.google.com/mail/?view=cm&fs=1&to=727722eucs126@skcet.ac.in" target="_blank">727722eucs126@skcet.ac.in</a></li>
